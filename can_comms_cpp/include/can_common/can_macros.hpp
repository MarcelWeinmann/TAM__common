...
/**
 * These macros should decrease duplicate code and simplify handling CAN message encoding and
 * decoding
 *
 * The idea is to call the correct funcitons based on their name and assemble the calls by frame and
 * signal
 *
 * !!! There is a strict version for all the macros, which REQUIRES THE FRAME VARIABLE TO HAVE THE
 * SAME NAME AS THE FRAME IN THE DBC !!!
 *
